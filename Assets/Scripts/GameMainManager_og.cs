...
public class GameMainManager_og : SingletonBehaviour<GameMainManager_og>
{
    ...
    private Dictionary<int, GameAgent_og> m_agentMap = new Dictionary<int, GameAgent_og>();

    // Use this for initialization
    void Start()
    {
        Simulator.Instance.setTimeStep(0.25f);
        Simulator.Instance.setAgentDefaults(15.0f, 10, 5.0f, 5.0f, 10.0f, 2.0f, new Vector2(0.0f, 0.0f));
    ...
    void CreatAgent()
    {
        ...
        if (sid >= 0)
        {
            ...
            GameAgent_og ga = go.GetComponent<GameAgent_og>();
            Assert.IsNotNull(ga);
            ga.sid = sid;
