public static class Constants
{
    ...
    public const float printRate = 0.3f; // g/s, printable -> spare module rate
    ...
    public const float failureChance = 0.005f; // probability of failing

    public const float roverSpeed = 0.01f; // m/s (curiosity is like 0.04)
}
