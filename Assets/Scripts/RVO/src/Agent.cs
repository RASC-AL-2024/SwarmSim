        ...
        internal void computeNewVelocity()
        {
            ...
            for (int i = 0; i < obstacleNeighbors_.Count; ++i)
            {
                ...
                else if (s > 1.0f && distSq2 <= radiusSq)
                {
                     ...
                     */
                    if (obstacle2.convex && RVOMath.det(relativePosition2, obstacle2.direction_) >= 0.0f)
                    {
                        line.point = new Vector2(0.0f, 0.0f);
                ...
                if (obstacle1.convex && RVOMath.det(leftLegDirection, -leftNeighbor.direction_) >= 0.0f)
                {
                ...
                if (obstacle2.convex && RVOMath.det(rightLegDirection, obstacle2.direction_) <= 0.0f)
                {
            ...
            int lineFail = linearProgram2(orcaLines_, maxSpeed_, prefVelocity, false, ref newVelocity);

            if (lineFail < orcaLines_.Count)
            {
                linearProgram3(orcaLines_, numObstLines, lineFail, maxSpeed_, ref newVelocity);
            }
        }
