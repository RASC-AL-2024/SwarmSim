...
namespace RVO
{
    ...
    public class Simulator
    {
        ...
        public int addAgent(Vector2 position)
        {
            ...
            agent.velocity = defaultAgent_.velocity;
            agents_.Add(agent);
            onAddAgent();
            return agent.id_;
        }
        ...
        {
            return agents_[agentNo2indexDict_[agentNo]].prefVelocity;
        }
        ...
        {
            return agents_[agentNo2indexDict_[agentNo]].velocity;
        }
        ...
        {
            agents_[agentNo2indexDict_[agentNo]].prefVelocity = prefVelocity;
        }
